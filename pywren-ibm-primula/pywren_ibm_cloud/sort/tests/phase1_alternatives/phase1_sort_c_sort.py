...
def _partition_into_segments_standalone(args, ibm_cos):
    ...
    def _chunk_consumer(t_i):
        ...
        while True:
            ...
            if read_cnks == len(read_bounds) - 1:
                ...
                df.columns = [nms[0]]
                for nm in nms[1:]:
                    if nms[parser_data['column_numbers'][0]] == nm:
                ...
                return df[nms], end_final_sort-start_final_sort
    ...
    ed, final_sort_time  = consumer_future.result()
    ...
    return final_sort_time/(data_upload_time - start_time)
